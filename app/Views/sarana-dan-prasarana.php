            ...
            <div class="main-news-card p-4">
                ...
                <?php if (!empty($saranaPrasarana)): ?>
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                        <?php foreach ($saranaPrasarana as $item): ?>
                            <div class="col">
                                <div class="sarpras-card">
                                    <?php if (!empty($item['gambar_thumbnail'])): ?>
                                        <img src="<?= base_url('sarana-prasarana/' . $item['gambar_thumbnail']) ?>" alt="<?= esc($item['nama']) ?>">
                                    <?php else: ?>
                                    ...
                                    <div class="sarpras-overlay">
                                        ...
                                        <?php if (!empty($item['file_video'])): ?>
                                            <a href="<?= base_url('sarana-prasarana/' . $item['file_video']) ?>" target="_blank" class="btn btn-sm btn-link mt-auto">
                                                <i class="bi bi-play-circle"></i> Lihat Footage
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                </div>
