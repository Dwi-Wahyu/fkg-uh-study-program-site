...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?= base_url('admin/survei/store') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <textarea
                    ...
                    id="deskripsi"
                    rows="5"
                    placeholder="Masukkan deskripsi survei"><?= old('deskripsi') ?></textarea>
            ...
            <div class="mb-3">
                <label for="link" class="form-label">Link Survey <span class="text-danger">*</span></label>
                <input
                    type="url"
